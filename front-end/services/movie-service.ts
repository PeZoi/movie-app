...
export const movieService = {
  ...
  // API lấy phim theo id của diễn viên
  getMoviesByActorId: async (actorId: string, page: string = '1', limit: string = '32') => http.get<PaginationResponseType<MovieType[]>>(`/api/v1/movie/actor/${actorId}?current=${page}&pageSize=${limit}`),
};